...
- **File + Function:** [`catalogue_detail_live.ex`](file://lib/phoenix_kit_catalogue/web/catalogue_detail_live.ex#L955-L972) – `handle_event("set_bulk_move_categories_disposition", ...)` & `handle_event("select_bulk_move_categories_target", ...)`
...
- **File + Function:** [`components.ex`](file://lib/phoenix_kit_catalogue/web/components.ex#L1681-L1697) – `format_supplier_costs/1`
...
- **File + Function:** [`catalogue_detail_live.ex`](file://lib/phoenix_kit_catalogue/web/catalogue_detail_live.ex#L2144-L2155) – `refresh_supplier_costs/1`
...
- **File + Function:** [`catalogue_detail_live.ex`](file://lib/phoenix_kit_catalogue/web/catalogue_detail_live.ex#L1750-L1815) – `category_move_targets/1` & `do_bulk_move_categories/3`
...
- **File + Function:** [`catalogue_detail_live.ex`](file://lib/phoenix_kit_catalogue/web/catalogue_detail_live.ex#L480-L511) – `handle_info({:bulk_change_apply, ...})`
